...
public class RobotConstants {
    ...
    public static double outtakeRotateSpecimenScore0 = 0.55;
    ...
    public static double outtakePivotTransfer= 0.81; //0
    ...
    public static double outtakeRotateSpecimenScore0After = 0.6;
